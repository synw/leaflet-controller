[Leaflet controller documentation](../README.md) / [Modules](../modules.md) / use\_marker\_controller
...
[use_marker_controller.ts:5](https://github.com/synw/leaflet-controller/blob/4e36a5e/src/use_marker_controller.ts#L5)
